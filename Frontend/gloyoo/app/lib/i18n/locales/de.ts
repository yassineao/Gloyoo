  ...
  pages: {
    about: {
      ...
      infos: [
        {
          value: "Remote",
          label: "Flexible Zusammenarbeit ohne Standortgrenzen.",
        },
        {
          value: "360°",
          label: "Strategie, Content, Webdesign und Performance aus einer Hand.",
        },
        {
          value: "Fokus",
          label: "Digitale Auftritte, die Vertrauen und Anfragen aufbauen.",
        },
      ],
      sections: [
        {
      ...
      team: {
        eyebrow: "Unser Team",
        title: "Die Menschen hinter Strategie, Design und Wachstum",
        description:
          "Wir arbeiten in schlanken Rollen zusammen, damit jedes Projekt klar geführt, sauber gestaltet und messbar optimiert wird.",
        members: [
          {
            name: "Yassine Ouazzani Amri",
            role: "Fullstack Developer & Design Lead",
            description:
              "Verantwortlich für technische Umsetzung, Designsysteme und die Entwicklung skalierbarer Weblösungen.",
          },
          {
            name: "Alae Tajjiou",
            role: "Content & Marketing Lead | Sales Support",
            description:
              "Entwickelt zielgerichtete Inhalte und Kampagnen und unterstützt den Vertrieb mit überzeugender Kommunikation.",
          },
          {
            name: "Abdellah Herraq",
            role: "Social Media Content Manager",
            description:
              "Optimiert Reichweite, Engagement und Kampagnenperformance auf Basis datengetriebener Strategien.",
          },
        ],
      },
