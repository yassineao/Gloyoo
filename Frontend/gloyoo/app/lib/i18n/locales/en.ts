      ...
      sections: [
        {
          ...
          points: [
            "Clear planning for content and campaigns",
            "Aligned processes across brand, design & performance",
            "Measurable priorities for sustainable growth",
            "Structured collaboration - internal and external",
            "Faster decisions with clear approval flows",
            "Full overview of all ongoing activities",
            "Reliable execution across every channel",
            "Full transparency on progress and results",
            "Planned actions instead of reactive firefighting",
          ],
        },
        {
          title: "Develop your website strategically",
          points: [
            "Content structured for your target audience",
            "Design and UX optimized for trust",
            "Clear messaging for every offer and service",
            "Seamless experience on mobile and desktop",
            "Quick updates without added complexity",
            "Consistent brand presence across all pages",
            "High-impact conversion elements, placed with intent",
            "Flexible content for campaigns and promotions",
            "Solid technical base for visibility and performance",
          ],
        },
        {
          title: "Design brand presence consistently",
          points: [
            "One cohesive look across social, web & ads",
            "Recognizable content with real brand impact",
            "A design system built for everyday use",
            "Ready-to-use templates for posts, pages & campaigns",
            "Creative ideas executed with precision",
            "Brand values translated into visuals and tone",
            "Flexible enough for new formats and trends",
            "Professional presence at every touchpoint",
            "Consistent — without losing what makes you unique",
  ...
  pages: {
    about: {
      ...
      infos: [
        {
          value: "Remote",
          label: "Flexible collaboration without location barriers.",
        },
        {
          value: "360°",
          label: "Strategy, content, web design, and performance in one place.",
        },
        {
          value: "Focus",
          label: "Digital presences built to create trust and inquiries.",
        },
      ],
      sections: [
        {
      ...
      team: {
        eyebrow: "Our Team",
        title: "The people behind strategy, design, and growth",
        description:
          "We work in lean roles so every project is clearly led, carefully designed, and measurably optimized.",
        members: [
          {
            name: "Yassine Ouazzani Amri",
            role: "Fullstack Developer & Design Lead",
            description:
              "Leads technical development, design systems, and scalable web solutions.",
          },
          {
            name: "Alae Tajjiou",
            role: "Content & Marketing Lead | Sales Support",
            description:
              "Creates targeted content and campaigns while supporting sales with clear, compelling communication.",
          },
          {
            name: "Abdellah Herraq",
            role: "Social Media Content Manager",
            description:
              "Optimizes reach, engagement, and campaign performance through data-driven strategies.",
          },
        ],
      },
