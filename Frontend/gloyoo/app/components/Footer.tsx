                    ...
                    <div className="flex flex-col gap-8 lg:grid lg:grid-cols-12 lg:gap-10">
                        ...
                        <div className="flex justify-center lg:col-span-4 sm:px-24 lg:block lg:px-0">
                            <div className="flex items-center justify-center gap-4 sm:gap-5 lg:justify-start">
                                ...
                                {/* <p className="max-w-sm text-left text-sm leading-6 text-brand-graySoft sm:text-base">
                                    {content.tagline}
                                </p> */}
                            </div>
                        </div>
                            ...
                            <ul className="flex flex-wrap items-center justify-center gap-2 sm:justify-start lg:justify-end">
                                {content.legalLinks.map((link) => (
                                    <li key={link.label}>
                                        <Link
                                            href={localizedHref(link.href)}
                                            className="inline-flex min-h-[40px] items-center rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-xs text-brand-graySoft transition-all duration-200 hover:border-white/20 hover:bg-white/[0.06] hover:text-white sm:text-sm"
                                        >
                                            {link.label}
                                        </Link>
                                    </li>
