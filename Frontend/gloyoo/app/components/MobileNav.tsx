    ...
    <div className="relative lg:hidden">
      <div className="flex items-center gap-2">
        <LocaleSwitchLink
          ...
          className="inline-flex h-10 items-center rounded-full border border-white/10 bg-white/5 px-3 text-sm font-medium text-brand-graySoft transition-colors hover:border-white/20 hover:text-white"
        />
                  ...
                  >
                    ...
                    <span className="text-brand-grayMuted transition-colors group-hover:text-brand-petalPink">
                      {item.children?.length ? (
                        <span className="rounded-full border border-white/10 px-2 py-0.5 text-xs font-semibold text-brand-graySoft">
                          {item.children.length}
                        </span>
                      ) : (
                        <svg
                        ...
                        {item.children.map((child) => (
                          <li key={child.href}>
                            <Link
                              ...
                              onClick={closeMenu}
                              className="flex items-center justify-between rounded-lg px-3 py-2 text-sm text-brand-graySoft transition-colors hover:bg-white/6 hover:text-white"
                            >
