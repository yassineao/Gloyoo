...
export default function Services({
    ...
    const serviceArt = [
        ...
        { src: "/webDesign.svg", alt: "Web design illustration" },
        { src: "/KPI.svg", alt: "KPI illustration" },
    ];
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-5 text-center sm:p-6">
                                        ...
                                        <a href="#about-us" className="mt-4 inline-flex items-center justify-center gap-2 font-medium text-white transition-colors hover:text-white">
                                            {content.cta}
                                            <svg
