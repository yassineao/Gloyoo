          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
            <div className="mx-auto flex max-w-2xl flex-col items-start text-left lg:mx-0">
              ...
              <p className="max-w-xl text-base leading-7 text-brand-cloud sm:text-lg sm:leading-8 lg:text-xl">
                ...
                online sichtbar zu werden und Kunden zu gewinnen.
              </p>

              <div className="mt-8 flex w-full flex-col gap-3 sm:flex-row sm:flex-wrap">
                <button className="inline-flex h-11 w-full items-center justify-center rounded-md bg-brand-gray px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-cloud hover:text-brand-navyDark sm:w-auto">
                  Kostenloses Beratungsgespraech
                </button>

                <button className="inline-flex h-11 w-full items-center justify-center rounded-md bg-brand-charcoal px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-teal sm:w-auto">
                  Jetzt starten
                  <svg
